    ...
    <body>
          ...
          <header id="header" id="home">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between d-flex">
                  <div id="logo">
                    <a href="index.html"><img src="assets/img/logoudjaya.png" style="width: 30%" alt="" title="" /></a>
                  </div>
            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-start">
                    <div class="banner-content col-lg-7">
                        <h6 class="text-white text-uppercase">GrowTogetherEveryday</h6>
                        <h1>
                            Start your day <br>
                            with a Coffee				
                        </h1>
                        <a href="#promo" class="primary-btn text-uppercase">Get Promo</a>
                    </div>											
                </div>
            </div>
        </section>
        ...
        <section class="gallery-area section-gap" id="gallery">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a href="assets/img/profile1.jpg" class="img-pop-home">
                            <img class="img-fluid" src="assets/img/profile1.jpg" alt="">
                        </a>	
                        <a href="assets/img/profile.jpg" class="img-pop-home">
                            <img class="img-fluid" src="assets/img/profile.jpg" alt="">
                        </a>	
                        <a href="assets/img/profile4.jpg" class="img-pop-home">
                            <img class="img-fluid" src="assets/img/profile4.jpg" alt="">
                        </a>	
                    </div>
                    <div class="col-lg-8">
                        <a href="assets/img/profile2.jpg" class="img-pop-home">
                            <img class="img-fluid" src="assets/img/profile2.jpg" alt="">
                        </a>	
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="assets/img/profile3.jpg" class="img-pop-home">
                                    <img class="img-fluid" src="assets/img/profile3.jpg" alt="">
                                </a>	
                            </div>
                            <div class="col-lg-6">
                                <a href="assets/img/profile5.jpg" class="img-pop-home">
                                    <img class="img-fluid" src="assets/img/profile5.jpg" alt="">
                                </a>	
                            </div>
                        </div>
                    </div>
        ...
        <section class="menu-area section-gap" id="promo">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="menu-content pb-60 col-lg-10">
                        <div class="title text-center">
